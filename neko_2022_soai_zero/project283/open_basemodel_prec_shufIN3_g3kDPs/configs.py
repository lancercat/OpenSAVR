...
from neko_2022_soai_zero.configs.loadouts.protorec_v2 import arm_v2IN_prec_shuf_module_setDPS;
...
def model_mod_cfg(tr_meta_path_chs,tr_meta_path_mjst,maxT_mjst,maxT_chs):
    ...
    feat_ch=512;
    mods={};
    mods=arm_v2IN_prec_shuf_module_setDPS(mods,TAG+"chs_",maxT_chs,capacity,feat_ch,tr_meta_path_chs,wemb=0,shuf_speed=3,recon_speed=3);
    return mods;
...
def dan_single_model_train_cfg(save_root,dsroot,
    ...
    routines = {};
    routines = arm_water2_routine(routines, TAG+"chs_", osdanmk7g3_rec_cyc3ks_ocr_routine, maxT_chs, log_path,
                                  log_each, "dan_chs_");
