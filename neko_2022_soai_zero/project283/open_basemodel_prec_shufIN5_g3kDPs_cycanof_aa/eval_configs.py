...
from neko_2021_mjt.dss_presets.dual_no_lsct_32_adapt import get_eval_dss;
def dan_mjst_eval_cfg(
    ...
    if(log_path):
        ...
        epath=None;
    te_meta_path_chsjpn, te_meta_path_mjst, mjst_eval_ds, chs_eval_ds=get_eval_dss(dsroot,25,30,lhw=[32,128]);
    task_dict = {}
    ...
    task_dict = arm_base_task_default2(task_dict, "base_chs_", osdanmk7_eval_routine_cfg, 30,
                                         te_meta_path_chsjpn, chs_eval_ds,
                                         log_path);
