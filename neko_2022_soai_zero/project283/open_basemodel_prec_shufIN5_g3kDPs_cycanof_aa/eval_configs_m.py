...
from neko_2021_mjt.dss_presets.dual_no_lsct_32 import get_eval_dss_m;
def dan_mjst_eval_cfg(
    ...
    if(log_path):
        ...
        epath=None;
    te_meta_path_chsjpn, te_meta_path_mjst, mjst_eval_ds, chs_eval_ds=get_eval_dss_m(dsroot,25,30);
    task_dict = {}
