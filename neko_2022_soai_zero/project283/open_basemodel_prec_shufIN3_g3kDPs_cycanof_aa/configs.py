...
def model_mod_cfg(tr_meta_path_chs,tr_meta_path_mjst,maxT_mjst,maxT_chs):
    ...
    feat_ch=512;
    mods={};
    mods=arm_v2IN_prec_shuf_module_setDPS_cyc3(mods,TAG+"chs_",maxT_chs,capacity,feat_ch,tr_meta_path_chs,wemb=0,shuf_speed=3,recon_speed=3,cycspeed=3,cycaa=True);
    return mods;
