...
from neko_2022_soai_zero.visualization.result_compilers.make_tex import maketex;
from neko_sdk.visualization.compile_ocr import Kategory_remix,get_acr_stat,getres
        ...
        for p, c ,filters in zip(protocols, counters,filterss):
            ...
            for did in range(len(dss)):
                ...
                # "318prirC/open_basemodel_protorecIN3_g3ks/jtrmodels/OSTR/rec3_chs_prototyper/JAP_lang/"
                    src = os.path.join(root,devs[mid], methods[mid],"jtrmodels", p,modnames[mid],dss[did]);
