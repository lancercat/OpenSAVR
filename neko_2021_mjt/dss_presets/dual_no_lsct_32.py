...
def get_eval_dss(dsroot,maxT_mjst,maxT_chs,batch_size=1,lhw=[32,128]):
    te_meta_path_chsjap = get_jpn_te_meta(dsroot);
    ...
    chs_eval_ds = get_eval_jpn_color(dsroot, maxT_chs,hw=lhw);
...
def get_eval_dss_jk(dsroot,maxT_chs,batch_size=1):
    ...
    jap_eval_ds = get_eval_jpn_color(dsroot, maxT_chs,hw=[32,128]);
    kr_eval_ds = get_eval_kr_color(dsroot, maxT_chs,hw=[32,128]);
    return te_meta_path_jpn,te_meta_path_kr,jap_eval_ds,kr_eval_ds
